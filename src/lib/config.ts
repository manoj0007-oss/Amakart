export const config={apiBaseUrl:process.env.NEXT_PUBLIC_API_BASE_URL||'',appName:'Amakart',currency:'₹',deliveryCharge:40,freeDeliveryThreshold:499,taxRate:0.18,itemsPerPage:12} as const;
