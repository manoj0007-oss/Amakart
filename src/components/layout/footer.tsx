    ...
    <footer className="bg-gray-900 text-gray-300 mt-12">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div><h3 className="text-white font-bold mb-4">Contact</h3><ul className="space-y-2 text-sm"><li>support@amakart.in</li><li>1800-123-4567</li><li>Hyderabad, India</li></ul></div>
        </div>
        <Separator className="my-8 bg-gray-700" />
        <p className="text-center text-sm text-gray-500">&copy; 2026 Amakart. All rights reserved.</p>
      </div>
    </footer>
  );
}
